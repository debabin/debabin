...
- ### [🔮 fetches](https://github.com/siberiacancode/core/tree/main/packages/fetches)
  a lightweight and flexible HTTP client for making API requests.
- ### [🔮 apicraft](https://github.com/siberiacancode/core/tree/main/packages/apicraft)
  generate types, requests and hooks for your API with one command.
- ### [🎉 mock-config](https://github.com/siberiacancode/mock-config)
